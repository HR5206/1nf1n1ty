...
$('#authSignup')?.addEventListener('click', async ()=>{
  ...
  const err = $('#authPageError'); err.hidden=true;
  try{
  const base = { email, password, passwordConfirm: password, bio: "Hey there! I'm using this app." };
...
$('#saveProfile')?.addEventListener('click', async ()=>{
  ...
  const data = { bio: bio || "Hey there! I'm using this app." };
...
async function renderProfile(){
  ...
  $('#profileEmail').textContent = me.email;
  $('#profileBio').textContent = me.bio || "Hey there! I'm using this app.";
