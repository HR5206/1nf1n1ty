...
document.getElementById('authSignup')?.addEventListener('click', async (e)=>{
  ...
  await setUserDoc(uid, { email, bio: "Hey there! I'm using this app.", avatar_url, created_at: serverTimestamp() });
...
document.getElementById('saveProfile')?.addEventListener('click', async ()=>{
  ...
  await setUserDoc(me.uid, { bio: bio || "Hey there! I'm using this app.", avatar_url });
...
async function renderProfile(){
  ...
  document.getElementById('profileEmail').textContent = me.email;
  document.getElementById('profileBio').textContent = p?.bio || "Hey there! I'm using this app.";
